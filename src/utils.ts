...
import { BaseErc20Factory } from '@tulilabs/core/dist/typechain'
...
export function chainIdToNetworkName(chainId: number): string {
  ...
  invariant(false, `chainId ${chainId} not officially supported by the Tuli Protocol`)
}
...
/**
 * Signs a Tuli Permit Message as specified by EIP-712
 *
 * @param owner
 * @param toAddress
 * @param mediaId
...
/**
 * Recovers the address of the private key that signed the Tuli Permit Message
 *
 * @param toAddress
 * @param mediaId
 * @param nonce
...
/**
 * Recovers the address of the private key that signed a Tuli MintWithSig Message
 *
 * @param contentHash
 * @param metadataHash
...
/**
 * Signs a Tuli MintWithSig Message as specified by EIP-712
 *
 * @param owner
 * @param contentHash
 * @param metadataHash
