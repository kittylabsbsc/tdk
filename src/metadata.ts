...
} from '@tulilabs/media-metadata-schemas/dist/src'
import * as MetadataTypes from '@tulilabs/media-metadata-schemas/dist/types/types'
...
/**
 * Generates alphabetized, minified JSON for the specified Tuli Metadata Schema Version.
