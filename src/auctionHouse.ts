...
} from '@tulilabs/auction-house/dist/typechain'
import rinkebyAddresses from '@tulilabs/auction-house/dist/addresses/4.json'
import mainnetAddresses from '@tulilabs/auction-house/dist/addresses/1.json'
import polygonAddresses from '@tulilabs/auction-house/dist/addresses/137.json'
import bscAddresses from '@tulilabs/auction-house/dist/addresses/56.json'
...
export class AuctionHouse {
  ...
  public readonly tuliAddress: string
  ...
  constructor(signerOrProvider: Signer | Provider, chainId: number) {
    ...
    this.tuliAddress = addresses[network].media
  }
  ...
  public async createAuction(
    ...
    auctionCurrency: string,
    tokenAddress: string = this.tuliAddress
  ) {
